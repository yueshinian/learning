...
parser.add_argument('--demo_folder', type=str, default='./images', help='path to the folder containing demo images')
parser.add_argument('--snapshot', type=str, default='./pretrained_models/dfnetv2_sfnet.pth', help='pre-trained checkpoint')
